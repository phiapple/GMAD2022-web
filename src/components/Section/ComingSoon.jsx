...
const ComingSoon = () => {
	return (
		<>
			<section className="  h-screen comingSoon-bgImg bg-cover">
				<div className="  h-full items-center justify-center mx-auto block md:max-w-screen atalks-bg-1">
					<div className=" block text-center items-center mx-10 md:mx-80">
						<div className="pt-80 lg:pt-96 mx-auto items-center">
							<div className="comingSoon-bg mx-auto py-8 rounded-full w-full max-w-3xl" data-aos="fade-left"
						data-aos-delay="500">
