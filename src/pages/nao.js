...
function nao() {
	return (
		<>
			...
			<div className="h-screen w-full pl-20 py-36 gap-10 flex items-center justify-center bg-green-light">
				...
				<div className="flex-[3] w-full h-full">
					...
					>
						{timelines.map((val, index) => {
							return (
								<SwiperSlide
									className="h-full w-[15vw] p-4 flex flex-col gap-4 rounded-2xl break-words profile-card outline-gradient"
									key={index}
								>
									...
									<button className="p-2 rounded-full border-2 font-medium text-c-yellow border-c-yellow bg-transparent">
										learn more
									</button>
								</SwiperSlide>
							);
			...
			<div className="relative h-[180vh] w-full bg-nao2">
				...
				<div className="absolute z-10 w-full h-full p-36 flex flex-col gap-60 items-center justify-center ">
					<div className="flex flex-col items-center justify-center gap-10">
						...
						<button className="w-fit px-4 py-2 bg-transparent border-2 border-c-yellow rounded-full text-c-yellow font-medium">
							Learn more
						</button>
					</div>
					...
					<div className="relative flex flex-col items-center justify-center gap-10 w-full">
						...
						<div className="p-4 h-[30vw] w-[30vw] flex items-center justify-center glassmo rounded-full text-c-yellow outline-gradient">
