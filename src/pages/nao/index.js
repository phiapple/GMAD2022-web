			...
			<div className="h-screen w-full pl-20 py-36 gap-10 flex items-center justify-center bg-green-light max-w-full overflow-hidden">
				<div className="flex-[1] flex flex-col gap-10">
					...
					<div className="flex gap-5">
						<IoChevronBack className="p-2 w-10 h-10 rounded-full text-c-yellow border border-c-yellow hover:bg-c-yellow hover:text-green-dark cursor-pointer" />
						<IoChevronForward className="p-2 w-10 h-10 rounded-full text-c-yellow border border-c-yellow hover:bg-c-yellow hover:text-green-dark cursor-pointer" />
					</div>
				</div>
